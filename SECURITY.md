...
Report vulnerabilities privately through the [Portable Resume security advisory page](https://github.com/aa22396584/resume-skills/security/advisories/new). Do not include real session stores, credentials, or recovered private text in reports.
