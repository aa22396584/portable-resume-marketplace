...
description: Import inert local OpenCode session context into a fresh session using a validated request document.
---

# resume-opencode

Import inert local **OpenCode** session context into a **fresh** session.
