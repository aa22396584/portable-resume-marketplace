...
## Host activation (codex-v1)

Invoke `$resume-<source>` followed by ordinary labeled text. There is no implicit skill-to-process argv binding.

Do not invent positional argv placeholders for this host.
